...
export const getReviews = () => dispatch => {
  ...
  Axios.get(`${BASE_URL}/reviews/reviews/paging`, requestOptions)
    .then(res => {
...
export const addReview = newReview => dispatch => {
  ...
  Axios.post(`${BASE_URL}/review/book/${newReview.bookId}`, newReview)
    .then(res => {
...
export const deleteReview = id => dispatch => {
  ...
  Axios.delete(`${BASE_URL}/data/reviews/${id}`)
    .then(res => {
